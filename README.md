...
* AWS account.
* Own Domain.
* Knowledge and familiarity with AWS Services & Pricing.
* Patience and Curiosity.

# 🧩 Architecture Overview.
The project is modularized into five key components as follows,  
...
# 💸 Cost associated
Even with AWS Free Tier, real-time hosting incurs costs. Key services that may generate charges:  
* **AWS Sheild**
* **AWS R53, for Domain**
...
# 🧪 Future Scope
* Add CI/CD with GitHub Actions & AWS CodePipeline.
